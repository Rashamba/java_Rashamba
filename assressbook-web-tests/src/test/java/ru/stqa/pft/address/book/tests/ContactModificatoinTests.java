...
public class ContactModificatoinTests extends TestBase {
  ...
  public void testContactModificatoin() {
    ...
    app.getContactHelper().fillContactForm(new ContactData("igor", "Krasnoborodko", "Rashamba", "Voronezh", "666999", "Egar", "test@gmail.com", "27", "September", "1993", "TestAddress", "777", null), false);
